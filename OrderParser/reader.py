from OrderParser.seller import TenByTen, Book, StoreFarm, Ably, TwentyNineCM, Idus, CafeTwentyFour
...
class Reader:
    ...
    def transform_sheet(self, file):
        ...
        elif unicodedata.normalize('NFKC', "orders") in filename:
            return self.csv_reader.get_order_list(file=file, seller=CafeTwentyFour(), encoding="utf-8")
        else:
